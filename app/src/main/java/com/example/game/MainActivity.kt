...
class MainActivity : AppCompatActivity() {
    ...
    private fun animateBall() {
        ...
        animator.addUpdateListener { animation ->
            ...
            // Check for collision after moving the ball
            checkCollision()
        }
        animator.start()
    }
    ...
    private fun movePaddleInitialPosition() {
        val displayMetrics = resources.displayMetrics
        val screenWidth = displayMetrics.widthPixels.toFloat()
        val screenHeight = displayMetrics.heightPixels.toFloat()
    ...
    private fun movePaddle(x: Float) {
        ...
        // Constrain paddle movement within the screen width
        val screenWidth = resources.displayMetrics.widthPixels.toFloat()
        paddleX = paddleX.coerceIn(0f, screenWidth - paddle.width)
        paddle.x = paddleX
    }
